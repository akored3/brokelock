...
function Run({ burned, ariaHidden }) {
  return (
    <span
...
// Only the duplicate run is aria-hidden; the first carries real content (burn total,
// contract address) that screen readers should get.
